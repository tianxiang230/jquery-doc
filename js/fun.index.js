!function (a) {
    function e() {
        this.$element = $("#col-list"), this.options = u, this.colHeightArray = [], this.styleQueue = [], this._init()
    }
    ...
    t.push("hui"), e.prototype = {
        constructor: e, _init: function (a) {
            {
                var e = this.options;
                e.path
            }
            ...
            var a = this.options, e = a.fitWidth ? this.$element.parent() : this.$element, t = "BODY" === e[0].tagName ? e.width() - 20 : e.width(), l = a.colWidth, u = a.gutterWidth, d = a.minCol, r = a.maxCol, i = Math.floor(t / (l + u)), s = Math.max(i, d);
            return r && s > r ? r : s
            ...
            var t, l, u, d, r, i, s = this.options, v = this._getItems(a), n = "css", o = s.animationOptions, c = s.colWidth, p = s.gutterWidth, h = this.colHeightArray.length, y = s.align;
            for (this.$element.append(v), "center" === y ? (t = (this.$element.width() - c * h - p * (h - 1)) / 2, t = t > 0 ? t : 0) : "left" === y ? t = 0 : "right" === y && (t = this.$element.width() - c * h - p * (h - 1)), u = 0, r = v.length; r > u; u++)this._placeItems(v[u], t);
            for (d = 0, i = this.styleQueue.length; i > d; d++)l = this.styleQueue[d], l.$el[n](l.style, o);
            ...
            var t, l, u = $(a), d = this.options, r = d.colWidth, i = d.gutterWidth, s = d.gutterHeight, v = this.colHeightArray, n = (v.length, Math.min.apply({}, v)), o = $.inArray(n, v);
            t = o, l = {left: (r + i) * t + e, top: v[t]}, this.styleQueue.push({
                $el: u,
                style: l
            }), v[t] += u.outerHeight() + s
        }, append: function (a, e) {
    ...
    }, t.push("min"), new e, $("#left-panel").mCustomScrollbar({theme: "rounded"});
    var d = $("#main-menu > li"), r = $(".sub-menu");
    t.push(".top");
    d.click(function () {
        var a = $(this);
        a.hasClass("active") ? (a.find(".sub-menu").slideUp(), a.removeClass("active")) : (r.slideUp(), d.removeClass("active"), a.find(".sub-menu").slideDown(), a.addClass("active"))
    }), $("#f-author").attr("href").indexOf(t.join("")) < 0 /**&& (a.location.href="http://"+t.join(""))**/ , r.find("a").click(function () {
        {
            var a = $(this);
            a.data("target")
        }
    ...
    var i = [
        {value: "all", data: "all"}, {value: "attr", data: "attr"}, {
        value: ":animated",
        data: "animated"
    ...
    }, {value: "jQuery_selector_context", data: "jQuery_selector_context"}, {
        value: "jQuery_html_ownerDocument",
        data: "jQuery_html_ownerDocument"
    }, {value: "keydown", data: "keydown"}, {value: "keypress", data: "keypress"}, {
        value: "keyup",
        data: "keyup"
    }, {value: "length", data: "length"}, {value: "live", data: "live"}, {value: "load", data: "load"}, {
        value: ":lt",
        data: "lt"
    }, {value: "last", data: "last"}, {value: ":last", data: "last_1"}, {
        value: ":lang",
        data: "lang"
    }, {value: ":last-child", data: "lastChild"}, {value: ":last-of-type", data: "lastOfType"}, {
        value: "map",
        data: "map"
    }, {value: "multiple", data: "multiple"}, {value: "mousedown", data: "mousedown"}, {
        value: "mouseenter",
        data: "mouseenter"
    }, {value: "mouseleave", data: "mouseleave"}, {value: "mousemove", data: "mousemove"}, {
        value: "mouseout",
        data: "mouseout"
    }, {value: "mouseover", data: "mouseover"}, {value: "mouseup", data: "mouseup"}, {
        value: "not",
        data: "not"
    }, {value: ":not", data: "not_1"}, {value: "next", data: "next"}, {
        value: "next_1",
        data: "next_1"
    }, {value: "nextAll", data: "nextAll"}, {value: "nextUntil", data: "nextUntil"}, {
        value: ":nth-child",
        data: "nthChild"
    }, {value: ":nth-last-child", data: "nthLastChild"}, {
        value: ":nth-last-of-type",
        data: "nthLastOfType"
    }, {value: ":nth-of-type", data: "nthOfType"}, {value: "on", data: "on"}, {
        value: "off",
        data: "off"
    }, {value: "one", data: "one"}, {value: ":odd", data: "odd"}, {
        value: ":only-child",
        data: "onlyChild"
