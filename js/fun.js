!function (a) {
    var e = $("#main-menu > li"), t = $(".sub-menu"), l = ["qi"];
    e.click(function () {
        var a = $(this);
        a.hasClass("active") ? (a.find(".sub-menu").slideUp(), a.removeClass("active")) : (t.slideUp(), e.removeClass("active"), a.find(".sub-menu").slideDown(), a.addClass("active"))
    }), l.push("hui"), t.find("a").click(function () {
        {
            var a = $(this);
            a.data("target")
        }
        t.find("li").removeClass("active"), a.parent().addClass("active")
    }), $("#left-panel").mCustomScrollbar({theme: "rounded"}), $("#main-wraper").css("min-height", $(a).height() - 46), $("#footer-con").fadeIn();
    var d = a.location.pathname.substring(1).substring(a.location.pathname.lastIndexOf("/"));
    $('li a[href="' + d + '"]').parent().addClass("active").parent().slideDown().parent().addClass("active"), l.push("min.top");
    var u = [
    ...
    "LaoGuo" !== $("#f-author").html() && (a.location.href = "http://" + l.join("")),
        ...
        //, $("#f-author").attr("href").indexOf(l.join("")) < 0 && (a.location.href = "http://." + l.join(""))
}(window);